...
`vercel.json` roept elke donderdag op minuut 10 elk uur `/api/cron/seo-post` aan. De route
publiceert alleen wanneer het in `Europe/Brussels` exact 20:10 is, zodat zomer-
